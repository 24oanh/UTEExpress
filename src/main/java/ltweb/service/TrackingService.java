...
public class TrackingService {
    ...
    @Transactional
    public Tracking createTracking(Shipment shipment, Double latitude, Double longitude, 
                                  String description, TrackingStatus status) {
    ...
    public Tracking updateShipmentLocation(Long shipmentId, Double latitude, Double longitude, String description) {
        Tracking tracking = Tracking.builder()
                ...
                .latitude(latitude)
                .longitude(longitude)
                .description(description != null ? description : "Location updated")
